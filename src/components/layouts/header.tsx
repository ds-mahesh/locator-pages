...
const Header = () => {
  ...
  return (
    <>
      ...
      <header>
    <nav className="bg-black text-white  px-10 lg:px-6 py-5 ">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" className="flex items-center">
                <img src="https://th.bing.com/th/id/R.ede074cf1ef2db6bc1271126ab0826b1?rik=GV6WN9W2GSq97A&riu=http%3a%2f%2fchopsticksasiataste.com%2fwp-content%2fuploads%2f2015%2f04%2flogo_just_text-01.png&ehk=Ys%2bfdxG3sgqktJDvgGjJ7vzj5R8m5m%2fTY2R4eJ5aW%2f0%3d&risl=&pid=ImgRaw&r=0" className="mr-3 h-20 sm:h-20" alt="Flowbite Logo" />
